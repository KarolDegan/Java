...
public class Frota{
    public static void main (String args[]){
        ...
        System.out.println("Digite i tamanho da frota: ");
        tam = nInput.nextInt();
        Veiculo frota[] = new Veiculo[tam];

        for(i=0;i<tam;i++){
            System.out.println("Tipo do "+ (i+1) + ".o veiculo (a - auto/ c - caminho): ");
            tipo = sInput.nextLine();

            if(!tipo.equalsIgnoreCase("a")&& !tipo.equalsIgnoreCase("c")) System.out.println("TIPO NÃO PREVISTO");
        ...
        for(i=0;i<=tam;i++){
            ...
            if(frota[i] != null) frota[i].imprime();
            System.out.println();
        }
